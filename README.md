...
<img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=1200&h=300&fit=crop" alt="Header Image" width="100%">
...
![English (C2)](https://img.shields.io/static/v1?label=language&message=English%20%28C2%29&color=red)
...
- Courses: Basics of Telecommunication, Business Communication and Communication, Business English for IT Specialists, CISCO: Basics of WAN’s, Understanding WAN Protocols, CISCO: Configuring Switches and Understanding VLANs, Computer Graphics Theory, Data Security and Cryptology, Database Administration, Database Integration and Optimisation, Digital Audio and Video Processing, Enterprise Economics, Enterprise Internship, Foundations of Software Testing, Information System Projects and Administration, Introduction to Informatics, Introduction to Information Processing, Introduction to Programming in Java Computers, IT Systems Support and Arrangement in Enterprises, Linux Administration, Logic and Algorithms Theory / Discrete Mathematics, Macroeconomics, Maintenance of Windows Workstations, Mathematical Analvsis, Network Administration, Routers, Network Applications I: Client-Server Systems Database Basics, Operating System Administration, Philosophy, Physics, Pre-Sessional Course in Mathematics, Probability Theory and Mathematical Statistics, Psychology, Scripting Languages, Social, Ethical and Professional Issues in IT, Software Protection, Study Setup and Introduction to Speciality, Telecommunications Networks, Windows Server Administration
